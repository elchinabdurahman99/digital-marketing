...
export default function ContactPageClient({ contact }: { contact?: { email?: string, phone?: string, address?: string } }) {
          ...
          <AnimateIn delay={100}>
            <div className="space-y-4">
              <div className="bg-white rounded-2xl border border-warm-200 p-6 shadow-[0_2px_16px_0_rgba(0,0,0,0.04)]">
                ...
                <div className="space-y-4">
                  {[
                    { icon: Mail,   label: "Email",         value: contact?.email || "hello@roivex.com" },
                    { icon: Phone,  label: "Phone",         value: contact?.phone || "+1 (234) 567-890" },
                    { icon: MapPin, label: "Location",      value: contact?.address || "New York, NY" },
